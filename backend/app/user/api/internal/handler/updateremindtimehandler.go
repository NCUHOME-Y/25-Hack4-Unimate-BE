...
func UpdateRemindTimeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateRemindTimeReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewUpdateRemindTimeLogic(r.Context(), svcCtx)
		resp, err := l.UpdateRemindTime(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
