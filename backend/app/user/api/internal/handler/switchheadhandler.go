...
func SwitchHeadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SwitchHeadReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewSwitchHeadLogic(r.Context(), svcCtx)
		resp, err := l.SwitchHead(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
