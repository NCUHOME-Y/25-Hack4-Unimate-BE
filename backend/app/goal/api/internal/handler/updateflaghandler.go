...
func UpdateFlagHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateFlagReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewUpdateFlagLogic(r.Context(), svcCtx)
		resp, err := l.UpdateFlag(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
