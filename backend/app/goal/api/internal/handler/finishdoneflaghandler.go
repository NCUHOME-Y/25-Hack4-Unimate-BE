...
func FinishDoneFlagHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FinishDoneFlagReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewFinishDoneFlagLogic(r.Context(), svcCtx)
		resp, err := l.FinishDoneFlag(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
