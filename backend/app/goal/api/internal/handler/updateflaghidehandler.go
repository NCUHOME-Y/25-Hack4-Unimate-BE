...
func UpdateFlagHideHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateFlagHideReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewUpdateFlagHideLogic(r.Context(), svcCtx)
		resp, err := l.UpdateFlagHide(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
