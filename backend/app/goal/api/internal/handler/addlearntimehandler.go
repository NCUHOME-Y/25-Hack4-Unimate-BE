...
func AddLearnTimeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddLearnTimeReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewAddLearnTimeLogic(r.Context(), svcCtx)
		resp, err := l.AddLearnTime(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
