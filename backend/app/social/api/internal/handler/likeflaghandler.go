...
func LikeFlagHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LikeFlagReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewLikeFlagLogic(r.Context(), svcCtx)
		resp, err := l.LikeFlag(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
