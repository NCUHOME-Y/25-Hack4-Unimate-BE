...
func PostUserPostHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostUserPostReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewPostUserPostLogic(r.Context(), svcCtx)
		resp, err := l.PostUserPost(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
