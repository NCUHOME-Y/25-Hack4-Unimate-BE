...
func CommentOnPostHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommentOnPostReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCommentOnPostLogic(r.Context(), svcCtx)
		resp, err := l.CommentOnPost(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
