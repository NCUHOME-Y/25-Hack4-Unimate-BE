...
func DeleteUserPostCommentHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewDeleteUserPostCommentLogic(r.Context(), svcCtx)
		resp, err := l.DeleteUserPostComment(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
