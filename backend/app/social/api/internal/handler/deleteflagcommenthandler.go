...
func DeleteFlagCommentHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteFlagCommentReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewDeleteFlagCommentLogic(r.Context(), svcCtx)
		resp, err := l.DeleteFlagComment(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
